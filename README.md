...
* Version 6.2.0 - 13 Jan 2026
    ...
    * Added small balances convert endpoints
    * Added restClient.V5Api.Account.Get/SetSpotMarginAutoRepayModeAsync endpoints
    * Added ParentOrderId to BybitOrder model
    * Added missing timestamping to SymbolOrderBook implementation
    * Removed MaxBalance property from BybitAdlAlert model as its deprecated
...
* Version 6.0.0 - 16 Dec 2025
    ...
    * Added support for setting Tp/Sl on Shared PlaceFuturesOrderAsync
    * Updated Shared API's subscription update types from ExchangeEvent to DataEvent
    * Removed deprecated leveraged token spot subscriptions

* Version 5.13.0 - 11 Nov 2025
    * Updated CryptoExchange.Net version to 9.13.0, see https://github.com/JKorf/CryptoExchange.Net/releases/
    * Added PostOnlyMaxLimitOrderQuantity to restClient..V5Api.ExchangeData.GetSpotSymbolsAsync response model

* Version 5.12.0 - 03 Nov 2025
